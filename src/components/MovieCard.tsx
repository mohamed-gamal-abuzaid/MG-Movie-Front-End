  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden bg-slate-200 dark:bg-slate-800">
        ...
        <div className="absolute top-2 left-2 flex items-center bg-slate-900/80 dark:bg-slate-950/80 backdrop-blur-md text-amber-400 text-[10px] sm:text-xs font-black px-2 py-1 rounded-lg border border-slate-700 dark:border-slate-800">
